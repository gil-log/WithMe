	...
	<div id="root">
        ...
        <div style = "text-align:center;">
	       	...
	       	<form method="get" action="/letter/letterwriteView" >
	          	...
	          	<button type="submit" style="background-color:transparent;  border:0px transparent solid;" width="25" height="40">
	            	<img src="${pageContext.request.contextPath}/resources/img/join.png" width="25" height="25"/>
	          	</button>
	       	</form>
       	</div>
		<hr />
